...
def triangle(num1, num2, num3)
  ary = [num1, num2, num3]
  return :invalid if ary.include?(0) || (ary.reduce(:+) - ary.max) < ary.max
  case ary.uniq.length
  when 1 then :equalateral
...
p triangle(1, 2, 5) #== :invalid
p triangle(1, 1, 2) #== :isosceles
